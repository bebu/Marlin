...
#define STRING_CONFIG_H_AUTHOR "(Sonnemann, Vyper config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 420 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 3  // (mm) Comment out to use the last-measured height
#endif
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE         15    // (mm/s) Feedrate for G26 XY moves.
    #define G26_XY_FEEDRATE_TRAVEL 150    // (mm/s) Feedrate for G26 XY travel moves.
